...
from config.news_parser_conf import PARSER_LOG_FILE, PARSER_DATA_PATH
...
def init_start():
    logger = Logger('nlp_parser', log2console=False, log2file=True, logfile=PARSER_LOG_FILE).get_logger()
