...
NLP_SERVER_NAME = os.environ.get("NLP_SERVER_NAME", 'video_classification')
...
# nlp模型
NLP_PREP_MODEL_PATH = os.path.join(PROJECT_DATA_PATH, NLP_SERVER_NAME, "preprocess_model")
NLP_MODEL_PATH = os.path.join(PROJECT_DATA_PATH, NLP_SERVER_NAME, "model")
if not os.path.exists(NLP_PREP_MODEL_PATH):
    os.mkdir(NLP_PREP_MODEL_PATH)
if not os.path.exists(NLP_MODEL_PATH):
    os.mkdir(NLP_MODEL_PATH)
